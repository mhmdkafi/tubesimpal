                    ...
                    <div class="form-content">
                        ...
                        <form id="login-form" method="post" action="/login">
                            ...
                            <div class="field input-field">
                                <input type="text" id="login-username" placeholder="Username" class="input" required name="name">
                            </div>
                            <div class="field input-field">
                                <input type="password" id="login-password" placeholder="Password" class="password" required name="password">
                        ...
                        <div class="form-link">
                            Don't have an account? <a href="/register" class="link signup-link">Signup</a>
                        </div>
                    </div>
                </div>
            </section>    
